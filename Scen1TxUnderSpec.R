...
colnames(effects) <- colnames(bootvar) <- colnames(coverage.ate) <- c("TMLE2", "TMLE3")
...
write.table(effects, file="EffectsS1MMIncorATx.csv", row.names=FALSE, col.names=TRUE, sep=",")
write.table(bootvar, file="VarS1MMIncorATx.csv", row.names=FALSE, col.names=TRUE, sep=",")
write.table(coverage.ate, file="CoverageATES1MMIncorATx.csv", row.names=FALSE, col.names=TRUE, sep=",")