...
write.table(effects, file="EffectsS1MMOut.csv", row.names=FALSE, col.names=TRUE, sep=",")
write.table(bootvar, file="VarS1MMOut.csv", row.names=FALSE, col.names=TRUE, sep=",")
write.table(coverage.ate, file="CoverageATES1MMOut.csv", row.names=FALSE, col.names=TRUE, sep=",")