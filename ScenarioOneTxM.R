...
write.table(effects, file="EffectsS1MMTx.csv", row.names=FALSE, col.names=TRUE, sep=",")
write.table(bootvar, file="VarS1MMTx.csv", row.names=FALSE, col.names=TRUE, sep=",")
write.table(coverage.ate, file="CoverageATES1MMTx.csv", row.names=FALSE, col.names=TRUE, sep=",")