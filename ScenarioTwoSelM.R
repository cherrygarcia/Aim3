...
write.table(effects, file="EffectsS2MMSel.csv", row.names=FALSE, col.names=TRUE, sep=",")
write.table(bootvar, file="VarS2MMSel.csv", row.names=FALSE, col.names=TRUE, sep=",")
write.table(coverage.ate, file="CoverageATES2MMSel.csv", row.names=FALSE, col.names=TRUE, sep=",")