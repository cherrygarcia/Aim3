...
write.table(effects, file="EffectsS2MMTrue.csv", row.names=FALSE, col.names=TRUE, sep=",")
write.table(bootvar, file="VarS2MMTrue.csv", row.names=FALSE, col.names=TRUE, sep=",")
write.table(coverage.ate, file="CoverageATES2MMTrue.csv", row.names=FALSE, col.names=TRUE, sep=",")