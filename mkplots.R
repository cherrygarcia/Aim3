...
dat.flucsvy2<-read.csv("EffectsS1MM.csv", header=TRUE, stringsAsFactors=FALSE)
cover.flucsvy2<-read.csv("CoverageATES1MM.csv", header=TRUE, stringsAsFactors=FALSE)
...
tmleS1box<-c(dat$Naive, dat$Tx_Sub, dat$SvySub, dat.btwts$BootIPW, dat.flucsvy2$TMLESvy1, dat.S1true2$TMLESvy2, dat.S1true2$TMLESvyFluc)
tmleS1cover<-c(cover$Naive, cover$Tx_Sub, cover$SvySub, cover.btwts$BootIPW, cover.flucsvy2$TMLESvy1, cover.S1true2$TMLESvy2, cover.S1true2$TMLESvyFluc)
...
dat.flucsvy2<-read.csv("EffectsS2MM.csv", header=TRUE, stringsAsFactors=FALSE)
cover.flucsvy2<-read.csv("CoverageATES2MM.csv", header=TRUE, stringsAsFactors=FALSE)
...
tmleS2box<-c(dats2$Naive, dats2$Tx_Sub, dats2$SvySub, dats2$TxSvySub, dat.flucsvy2$TMLESvy1, dat.S2true2$TMLESvy2, dat.S2true2$TMLESvyFluc)
tmleS2cover<-c(covers2$Naive, covers2$Tx_Sub, covers2$SvySub, covers2$TxSvySub, cover.flucsvy2$TMLESvy1, cover.S2true2$TMLESvy2, cover.S2true2$TMLESvyFluc)
...
tmleS2.cov.plot<-ggplot(data=tmleS2cover.dat, aes(x=lab1, y=tmleS2cover))  +
    geom_bar( stat="identity", fill="lightblue") +
scale_x_discrete(limits=c("TMLE3", "TMLE2", "TMLE1", "IPTSW", "IPTW", "IPSW",  "Naive"))+ 
  geom_text(data=sumcover.tmleS2, aes(x=lab1, y=meancov*100, label=meancov*100), vjust=0, size=3) + ggtitle("Coverage, Scenario 2") + xlab("") + ylab("") + theme(axis.text.x=element_text(size=7), title=element_text(size=9))
...
dat.S1mistx3<-read.csv("EffectsS1TxMM.csv", header=TRUE, stringsAsFactors=FALSE)
cover.S1mistx3<-read.csv("CoverageATES1TxMM.csv", header=TRUE, stringsAsFactors=FALSE)
dat.S1missel3<-read.csv("EffectsS1MisSelMM.csv", header=TRUE, stringsAsFactors=FALSE)
cover.S1missel3<-read.csv("CoverageATES1MisSelMM.csv", header=TRUE, stringsAsFactors=FALSE)

dat.S1misout4<-read.csv("EffectsS1MisOutMM.csv", header=TRUE, stringsAsFactors=FALSE)
cover.S1misout4<-read.csv("CoverageATES1MisOutMM.csv", header=TRUE, stringsAsFactors=FALSE)

tmleS1box<-c(
  dat.S1mistxmin$TxSvySub, dat.S1mistx3$TMLESvy1T1, dat.S1mistx3$TMLESvy2T1, dat.S1mistx2$TMLESvyFlucT1, 
  dat.S1mistxmaj$TxSvySub, dat.S1mistx3$TMLESvy1T2, dat.S1mistx3$TMLESvy2T2, dat.S1mistx2$TMLESvyFlucT2, 
  dat.S1misselmin$TxSvySub, dat.S1missel3$TMLESvy1S1, dat.S1missel2$TMLESvy2S1, dat.S1missel2$TMLESvyFlucS1, 
  dat.S1misselmaj$TxSvySub, dat.S1missel3$TMLESvy1S2, dat.S1missel2$TMLESvy2S2, dat.S1missel2$TMLESvyFlucS2,
  dat.S1misoutmin$TxSvySub, dat.S1misout4$TMLESvy1O1, dat.S1misout4$TMLESvy2O1, dat.S1misout2$TMLESvyFlucO1,
  dat.S1misoutmaj1$TxSvySub, dat.S1misout4$TMLESvy1O2, dat.S1misout4$TMLESvy2O2, dat.S1misout2$TMLESvyFlucO2,
  dat.S1misoutmaj2$TxSvySub, dat.S1misout4$TMLESvy1O3, dat.S1misout4$TMLESvy2O3, dat.S1misout2$TMLESvyFlucO3)
tmleS1cover<-c(
  cover.S1mistxmin$TxSvySub, cover.S1mistx3$TMLESvy1T1, cover.S1mistx2$TMLESvy2T1, cover.S1mistx2$TMLESvyFlucT1, 
  cover.S1mistxmaj$TxSvySub, cover.S1mistx3$TMLESvy1T2, cover.S1mistx2$TMLESvy2T2, cover.S1mistx2$TMLESvyFlucT2, 
  cover.S1misselmin$TxSvySub, cover.S1missel3$TMLESvy1S1, cover.S1missel2$TMLESvy2S1, cover.S1missel2$TMLESvyFlucS1, 
  cover.S1misselmaj$TxSvySub, cover.S1missel3$TMLESvy1S2, cover.S1missel2$TMLESvy2S2, cover.S1missel2$TMLESvyFlucS2,
  cover.S1misoutmin$TxSvySub, cover.S1misout4$TMLESvy1O1, cover.S1misout2$TMLESvy2O1, cover.S1misout2$TMLESvyFlucO1,
  cover.S1misoutmaj1$TxSvySub, cover.S1misout4$TMLESvy1O2, cover.S1misout2$TMLESvy2O2, cover.S1misout2$TMLESvyFlucO2,
  cover.S1misoutmaj2$TxSvySub, cover.S1misout4$TMLESvy1O3, cover.S1misout2$TMLESvy2O3, cover.S1misout2$TMLESvyFlucO3)
...
dat.S2mistx3<-read.csv("EffectsS2MMTxMis.csv", header=TRUE, stringsAsFactors=FALSE)
cover.S2mistx3<-read.csv("CoverageATES2MMTxMis.csv", header=TRUE, stringsAsFactors=FALSE)
dat.S2missel3tmp<-read.csv("EffectsS2MMSelMisTMLE1.csv", header=TRUE, stringsAsFactors=FALSE)
dat.S2missel3<-dat.S2missel3tmp[1:250,]
cover.S2missel3tmp<-read.csv("CoverageATES2MMSelMisTMLE1.csv", header=TRUE, stringsAsFactors=FALSE)
cover.S2missel3<-cover.S2missel3tmp[1:250,]
dat.S2misout4<-read.csv("EffectsS2MMOutMis.csv", header=TRUE, stringsAsFactors=FALSE)
cover.S2misout4<-read.csv("CoverageATES2MMOutMis.csv", header=TRUE, stringsAsFactors=FALSE)
...
tmleS2cover<-c(
  cover.S2mistxmin$TxSvySub, cover.S2mistx3$TMLESvy1T1, cover.S2mistx2$TMLESvy2T1, cover.S2mistx2$TMLESvyFlucT1, 
  cover.S2mistxmaj$TxSvySub, cover.S2mistx3$TMLESvy1T2, cover.S2mistx2$TMLESvy2T2, cover.S2mistx2$TMLESvyFlucT2, 
  cover.S2misselmin$TxSvySub, cover.S2missel3$TMLESvy1S1, cover.S2missel2$TMLESvy2S1, cover.S2missel2$TMLESvyFlucS1, 
  cover.S2misselmaj$TxSvySub, cover.S2missel3$TMLESvy1S2, cover.S2missel2$TMLESvy2S2, cover.S2missel2$TMLESvyFlucS2,
  cover.S2misoutmin$TxSvySub, cover.S2misout4$TMLESvy1O1, cover.S2misout2$TMLESvy2O1, cover.S2misout2$TMLESvyFlucO1,
  cover.S2misoutmaj1$TxSvySub, cover.S2misout4$TMLESvy1O2, cover.S2misout2$TMLESvy2O2, cover.S2misout2$TMLESvyFlucO2,
  cover.S2misoutmaj2$TxSvySub, cover.S2misout4$TMLESvy1O3, cover.S2misout2$TMLESvy2O3, cover.S2misout2$TMLESvyFlucO3)
labS2<-c(rep("IPTSW", 250), rep("TMLE1", 250), rep("TMLE2", 250),  rep("TMLE3", 250), rep("IPTSW", 250), rep("TMLE1", 250), rep("TMLE2", 250),  rep("TMLE3", 250),rep("IPTSW", 250), rep("TMLE1", 250), rep("TMLE2", 250),  rep("TMLE3", 250),rep("IPTSW", 250), rep("TMLE1", 250), rep("TMLE2", 250),  rep("TMLE3", 250),rep("IPTSW", 250), rep("TMLE1", 250), rep("TMLE2", 250),  rep("TMLE3", 250),rep("IPTSW", 250), rep("TMLE1", 250), rep("TMLE2", 250),  rep("TMLE3", 250),rep("IPTSW", 250), rep("TMLE1", 250), rep("TMLE2", 250),  rep("TMLE3", 250))
catS2<-c(rep("modtx", 1000), rep("majtx", 1000), rep("modsel", 1000), rep("majsel", 1000), rep("modout", 1000), rep("majout1", 1000),rep("majout2", 1000) )
